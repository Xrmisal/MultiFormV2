    ...
    <GuestLayout title="Register">
        <div class="mt-10 mx-auto w-full max-w-sm space-y-6">
            ...
            <div>
                ...
                <div class="mt-2">
                    <input type="name" name="name" id="name" autocomplete="name" required="" v-model="user.name" class="block w-full rounded-md bg-white/5 px-3 py-1.5 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-500 sm:text-sm/6" />
                </div>
            </div>
            <div>
        ...
        <router-link to="/login"class="mt-10 text-center text-sm/6 text-gray-400 hover:text-gray-200">
